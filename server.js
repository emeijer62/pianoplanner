...
const microsoftCalendarRoutes = require('./routes/microsoftCalendar');
const emailRoutes = require('./routes/email');
const emailTemplatesRoutes = require('./routes/emailTemplates');
const userSmtpRoutes = require('./routes/userSmtp');
...
app.use('/api/microsoft', microsoftCalendarRoutes);
                            ...
                            <div class="content">
                                ...
                                <div class="detail-card">
                                    <div class="detail-row">
                                        ...
                                        <div class="value">${signupData.name}</div>
                                    </div>
                                    <div class="detail-row">
                                        <div class="label">Email</div>
                                        <div class="value"><a href="mailto:${signupData.email}">${signupData.email}</a></div>
                                    </div>
                                    ${signupData.company ? `
                                    <div class="detail-row">
                                        <div class="label">Company</div>
                                        <div class="value">${signupData.company}</div>
                                    </div>
                                    ` : ''}
                                    <div class="detail-row">
